...
const routes = [
  ...
  { method: "POST", pattern: /^\/countries$/, handler: countries.lambdaHandler },
  ...
  { method: "PUT", pattern: /^\/countries\/([^/]+)$/, handler: countries.lambdaHandler, pathParamNames: ["id"] },
  { method: "DELETE", pattern: /^\/countries\/([^/]+)$/, handler: countries.lambdaHandler, pathParamNames: ["id"] },
  ...
  { method: "POST", pattern: /^\/teams$/, handler: teams.lambdaHandler },
  ...
  { method: "PUT", pattern: /^\/teams\/([^/]+)$/, handler: teams.lambdaHandler, pathParamNames: ["id"] },
  { method: "DELETE", pattern: /^\/teams\/([^/]+)$/, handler: teams.lambdaHandler, pathParamNames: ["id"] },
  ...
  { method: "POST", pattern: /^\/players$/, handler: players.lambdaHandler },
  ...
  { method: "PUT", pattern: /^\/players\/([^/]+)$/, handler: players.lambdaHandler, pathParamNames: ["id"] },
  { method: "DELETE", pattern: /^\/players\/([^/]+)$/, handler: players.lambdaHandler, pathParamNames: ["id"] },
